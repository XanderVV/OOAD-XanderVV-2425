...
{
    /// <summary>
    /// Service voor gebruikers authenticatie en autorisatie
    /// </summary>
    public class GebruikersService
    {
        ...
        public bool ValideerAdminCredentials(string gebruikersnaam, string wachtwoord)
        {
            try
            {
                ...
                // Controleer of de credentials bestaan in de config
